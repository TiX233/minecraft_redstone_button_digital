...
本仓库属于 [我的世界红石](https://gitee.com/TiX233/minecraft_redstone_repo) 的一个子部分，用于存储 `红石按钮` 软件相关的内容  
...
按键的延时可配置，默认为石制按键的 10rt（10 个红时刻，10*100ms）

本项目主要基于 PY32F002B 进行实现，通过自己设计的红石通信协议来在一个通信周期为所有红石元件内传递所有红石信号，具体的红石通信协议可以在 [主仓库](https://gitee.com/TiX233/minecraft_redstone_repo) 的 readme 文件中看到详细描述，此处不赘述
